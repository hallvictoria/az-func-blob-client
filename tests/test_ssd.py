...
class TestBlob(unittest.TestCase):
    ...
    def test_input_incorrect_type(self):
        ...
        with self.assertRaises(ValueError):
            blobClientConverter.decode(data=datum, trigger_metadata=None, pytype=StorageStreamDownloader)
    ...
    def test_input_populated(self):
        ...
        result: StorageStreamDownloader = blobClientConverter.decode(data=datum,
